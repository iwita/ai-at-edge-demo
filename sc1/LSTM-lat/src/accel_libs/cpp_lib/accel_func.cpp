...
void lstm_io(int time_steps, int features, int iunits, int ounits)
{
	size_t size_in_bytes = time_steps*features * sizeof(short int);
	size_t size_out_bytes = time_steps*features * sizeof(short int);
...
void lstm_accel(short int *input, short int *output, short int *Wi, short int *bi, short int *Wf, short int *bf, short int *Wc, short int *bc, short int *Wo, short int *bo, short int *W, short int *b, int time_steps, int init, int features, int iunits, int ounits)
{
